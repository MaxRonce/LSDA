"""
evaluate.py -- Performance evaluation and framework comparison.

Loads all 6 tuned models (3 sklearn + 3 PySpark), runs predictions on the
500K test set, and produces accuracy/AUC scores, a comparison table (CSV),
a bar chart comparing frameworks side-by-side, and a markdown summary report.
"""
